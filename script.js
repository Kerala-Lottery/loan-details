...
function displayDetails(userDetails) {
  ...
  detailsDiv.innerHTML = `
    ...
    <p style="font-size: 15px; padding: 5px;">*For Any Question or Issue, You Can Call Helpline No. +91 7074322989.</p>
    <p><a href = "tel:+917074322989" style = "padding: 5px 15px; background: #00c04b; text-decoration: none; color: #fff; border-radius: 5px;">CALL NOW</a></p>
    </div>
  `;
}
